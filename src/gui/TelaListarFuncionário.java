 ...
 * @author Elyson
 */
public class TelaListarFuncionário extends javax.swing.JFrame {

    Fachada fachada;
    
    public TelaListarFuncionário(Fachada fachada) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
     ...
     private void atualizarAreaTexto(){
        ArrayList<Funcionario> mensagem = fachada.listarFuncionario();
        this.areaTexto.list();
    }
