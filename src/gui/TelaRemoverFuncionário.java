 ...
 * @author Elyson
 */
public class TelaRemoverFuncionário extends javax.swing.JFrame {

    Fachada fachada;
    
    public TelaRemoverFuncionário(Fachada fachada) {
    ...
    private void initComponents() {
        ...
        jLabel4.setBounds(100, 310, 41, 22);
        ...
        entryCpf.setBounds(160, 310, 170, 30);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(cpf.equals("")){
            ...
            try{
                Funcionario f = fachada.buscarFuncionario(cpf);
